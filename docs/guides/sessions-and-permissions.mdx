...
When an agent wants to perform a sensitive action — writing files, running commands, accessing the network — Aura Companion intercepts the request and presents it for your approval.
...
This means you can restart Aura Companion without losing your work. The agent picks up where it left off.
